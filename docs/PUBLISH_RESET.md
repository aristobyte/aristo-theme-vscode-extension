...
```bash
code --uninstall-extension aristobyte.aristobyte-vscode-color-theme
```
...
```bash
npx @vscode/vsce unpublish aristobyte.aristobyte-vscode-color-theme
```
...
```bash
npx ovsx unpublish aristobyte.aristobyte-vscode-color-theme
```
